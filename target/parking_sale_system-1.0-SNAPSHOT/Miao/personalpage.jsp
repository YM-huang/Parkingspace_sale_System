...
<div id="fh5co-main">
    <div class="fh5co-tab-wrap">
        <ul class="fh5co-tab-menu">
            ...
            <li <c:if test="${state==3}">class="active"</c:if>><a href="#" data-tab="3"><span class="icon icon-black-tie"></span><span class="menu-text">Propertiy</span></a></li>
            <li <c:if test="${state==4}">class="active"</c:if>><a href="#" data-tab="4" data-pie="yes"><span class="icon icon-fighter-jet"></span><span class="menu-text">Security</span></a></li>
        </ul>
