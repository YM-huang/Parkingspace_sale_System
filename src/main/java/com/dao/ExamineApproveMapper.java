...
public interface ExamineApproveMapper {
    ...
    List<ExamineApprove> selectExamineApprove(@Param("pageNum") int pageNum,@Param("pageSize") int pageSize,@Param("adminId") String adminId,@Param("state") int state);
    ...
    boolean updateExamineApproveState(@Param("state") int state,@Param("eId") String eId);
