    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/administrators/admininfo" ><i class="fa fa-table"></i>个人信息</a>
                </li>
                <li>
                    <form action="${pageContext.request.contextPath}/administrators/admininfo" method="post">
                        <button><i class="fa fa-table"></i>个人信息</button>
                    </form>
                </li>
