    ...
    <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="index.html"><i class="fa fa-dashboard"></i> 入驻申请审批</a>
                ...
                <li>
                    <a href="ui-elements.html"><i class="fa fa-desktop"></i> 开发商信息处理</a>
                </li>
                <li>
                    <a href="chart.html"><i class="fa fa-bar-chart-o"></i> 客服信息</a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="#">信息查看</a>
                        </li>
                ...
                <li>
                    <a href="tab-panel.html"><i class="fa fa-qrcode"></i> 订单处理</a>
                </li>
